export const siteConfig = {
  ...
  brokerage: "Florida Morning Realty LLC",
...
export const profileContent = {
  ...
  stats: [
    ...
    ["16", "Closed Sales"],
    ["$6.4M", "Total Value"],
    ["$397.7K", "Average Price"],
    ["3310238", "Florida License"],
    ["5.0", "Zillow Rating"]
  ],
  specialties: [
...
export const clientHighlights = [
  "Responsive and helpful with purchasing and finding tenants.",
  "Organized, efficient, and attentive during the rental search.",
  "Experienced with property management and Sarasota-area rental needs."
];
